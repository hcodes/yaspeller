...
function formatFileName(resource) {
    return '<b>' + _.escape(resource) + '</b>';
}
    ...
    oneach: function(err, data) {
        ...
        if(err) {
            ...
            if(data.data && data.data.length) {
                html.unshift('<div class="err"><span class="sym-err">&chi;</span>' + formatFileName(data.resource) + time + '</div>');
            } else {
                html.unshift('<div class="ok"><span class="sym-ok">&checkmark;</span>' + formatFileName(data.resource) + time + '</div>');
            }
