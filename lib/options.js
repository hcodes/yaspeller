...
module.exports = {
    set: function(prefs) {
        program
            ...
            .option('--file-extensions <value>', 'set file extensions to search for files in a folder. Example: ".md,.html"', splitOnCommas, null)
            ...
            .option('--ignore-tags <tags>', 'ignore tags. Default: "' +
                ...
                '"', splitOnCommas, null)
            .option('--no-ignore-comments', 'do not ignore comments: <!-- -->, <![CDATA[ ]]>');
